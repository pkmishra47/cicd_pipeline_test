...
@Embedded
public class DBPrimaryCarePhysician implements Comparable<DBPrimaryCarePhysician>{
	...
	@Override
	public int compareTo(DBPrimaryCarePhysician arg0) {
		if(arg0 == null)
			throw new IllegalArgumentException("DBPrimaryCarePhysician is Null");
